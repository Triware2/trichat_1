...
INSERT INTO api_keys (name, key, permissions, created_by) VALUES
('Test API Key 1', 'sk-test123456789abcdef', ARRAY['chat:read', 'analytics:read'], auth.uid()),
('Test API Key 2', 'sk-test987654321fedcba', ARRAY['chat:write', 'settings:read'], auth.uid())
ON CONFLICT DO NOTHING;

-- Insert sample audit logs
INSERT INTO audit_logs (action, user_email, ip_address, details, severity, resource_type) VALUES
('user_login', 'admin@example.com', '192.168.1.1', '{"method": "email", "success": true}', 'low', 'auth'),
('api_key_generated', 'admin@example.com', '192.168.1.1', '{"key_name": "Test Key"}', 'low', 'api_key'),
('security_settings_updated', 'admin@example.com', '192.168.1.1', '{"mfa_enabled": true}', 'medium', 'settings')
ON CONFLICT DO NOTHING; 