...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Button 
                ...
                className="hover:bg-orange-50 text-slate-700"
              >
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            <Badge className="mb-6 bg-orange-100 text-orange-800 hover:bg-orange-200 border-orange-200 px-4 py-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button 
                ...
                className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white text-lg px-8 py-4 h-14 shadow-xl"
              >
                Start Free Trial
              ...
              <Button 
                ...
                variant="outline" 
                onClick={() => navigate('/demo')}
                className="text-lg px-8 py-4 h-14 border-2 border-slate-300 hover:border-orange-300 hover:bg-orange-50"
              >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <Badge className="mb-4 bg-slate-100 text-slate-800">Features</Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg hover:scale-105 hover:bg-gradient-to-br hover:from-orange-50 hover:to-red-50">
      ...
      {/* Dashboard Preview */}
      <section className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <Badge className="mb-4 bg-orange-500/20 text-orange-300 border-orange-500/30">Dashboards</Badge>
            ...
            <Card className="bg-gradient-to-br from-blue-500 to-cyan-500 text-white border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <CardTitle className="text-xl">Supervisor Hub</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-gradient-to-br from-emerald-500 to-teal-500 text-white border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <CardTitle className="text-xl">Agent Workspace</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <Badge className="mb-4 bg-slate-100 text-slate-800">Testimonials</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
              Trusted by Industry Leaders
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              See how teams worldwide are transforming their customer support operations
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-orange-600 via-red-600 to-orange-700 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative">
          ...
          <p className="text-xl text-orange-100 mb-10 leading-relaxed">
            Join thousands of companies delivering world-class customer experiences with SupportPro
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              onClick={() => navigate('/signup')}
              className="bg-white text-orange-600 hover:bg-orange-50 text-lg px-8 py-4 h-14 shadow-xl font-semibold"
            >
              Start Free Trial
              <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-white text-white hover:bg-white hover:text-orange-600 text-lg px-8 py-4 h-14 font-semibold"
            >
              Contact Sales
            </Button>
          </div>
      ...
      <footer className="bg-slate-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-400 mb-6 max-w-md leading-relaxed">
                The world's most advanced customer support platform, trusted by industry leaders worldwide.
              </p>
          ...
          <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400">&copy; 2024 SupportPro. All rights reserved.</p>
